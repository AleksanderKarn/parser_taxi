...
from reports.report_create import dserhgareh
...
class CarAdmin(admin.ModelAdmin):
    ...
    actions = ['parsing', 'avito_parser', 'arenda_parser', 'test']
    ...
    @admin.action(description='тест')
    def test(self, request, qs: QuerySet):
        dserhgareh()
